...
---@field generate fun(prompt: string, config: AIGitCommit.ProviderConfig, on_chunk: fun(content: string), on_done: fun(), on_error: fun(err: string)): AIGitCommit.StreamHandle?
